...
public:
    /** The type for each element in the list of buffers.
        ...
        `asio::mutable_buffer`, then this type will be
        `asio::mutable_buffer`, else this type will be
        `asio::const_buffer`.
    */
#if BEAST_DOXYGEN
...
#include <beast/core/impl/buffers_suffix.ipp>
