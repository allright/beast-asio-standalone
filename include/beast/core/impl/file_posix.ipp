...
#if ! defined(BEAST_NO_POSIX_FADVISE)
# if defined(__APPLE__) || (defined(ANDROID) && (__ANDROID_API__ < 21))
#  define BEAST_NO_POSIX_FADVISE
# endif
#endif

#if ! defined(BEAST_USE_POSIX_FADVISE)
# if ! defined(BEAST_NO_POSIX_FADVISE)
#  define BEAST_USE_POSIX_FADVISE 1
# else
#  define BEAST_USE_POSIX_FADVISE 0
# endif
#endif
