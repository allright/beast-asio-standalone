...
#ifndef BEAST_IMPL_BUFFERS_SUFFIX_IPP
#define BEAST_IMPL_BUFFERS_SUFFIX_IPP
...
{
    static_assert(
        asio::is_const_buffer_sequence<Buffers>::value||
        asio::is_mutable_buffer_sequence<Buffers>::value,
    ...
    buffers_suffix&
{
    ...
    bs_ = other.bs_;
    begin_ = std::next(
        asio::buffer_sequence_begin(bs_), dist);
    skip_ = other.skip_;
    return *this;
}
