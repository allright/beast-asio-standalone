...
#ifndef BEAST_IMPL_BUFFERS_PREFIX_IPP
#define BEAST_IMPL_BUFFERS_PREFIX_IPP
...
private:
    ...
    const_iterator(buffers_prefix_view const& b,
        ...
        : b_(&b)
        , remain_(b_->size_)
        , it_(asio::buffer_sequence_begin(b_->bs_))
    {
    }
};
