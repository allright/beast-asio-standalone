...
#ifndef BEAST_TEST_STREAM_HPP
#define BEAST_TEST_STREAM_HPP
...
/** A two-way socket useful for unit testing
    ...
    `asio::read_until`, or in a call to
    @ref beast::http::async_write for example.

    As with Boost.Asio I/O objects, a @ref stream constructs
    with a reference to the `asio::io_context` to use for
...
public:
    ...
    /** Destructor
        ...
        the peer will see the error `asio::error::connection_reset`
...
#include <beast/experimental/test/impl/stream.ipp>
