...
#ifndef BEAST_TEST_FAIL_COUNT_HPP
#define BEAST_TEST_FAIL_COUNT_HPP

#include <beast/core/error.hpp>
#include <beast/experimental/test/error.hpp>
...
#include <beast/experimental/test/impl/fail_count.ipp>
