...
#include <beast/experimental/core/detail/flat_stream.hpp>
...
/** Stream wrapper to improve ssl::stream write performance.
    ...
    a performance limitation of the current version of `asio::ssl::stream`,
    ...
    @li `asio::read`, `asio::async_read`

    @li `asio::write`, `asio::async_write`

    @li `asio::read_until`, `asio::async_read_until`
...
public:
    ...
    using lowest_layer_type = beast::get_lowest_layer<next_layer_type>;
    ...
    */
    ...
    /** Read some data from the stream.
        ...
        bytes. Consider using the function `asio::read` if you need to ensure
    ...
    */
    ...
    /** Start an asynchronous read.
        ...
        @note The `read_some` operation may not read all of the requested number of
        bytes. Consider using the function `asio::async_read` if you need
    ...
    */
    ...
    /** Write some data to the stream.
        ...
        peer. Consider using the function `asio::write` if you need to
    ...
    */
    ...
    /** Start an asynchronous write.
        ...
        the peer. Consider using the function `asio::async_write` if you need
...
#include <beast/experimental/core/impl/flat_stream.ipp>
