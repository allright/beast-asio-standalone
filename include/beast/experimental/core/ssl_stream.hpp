...
/** Provides stream-oriented functionality using OpenSSL
    ...
    @par Example
    To use this template with a `asio::ip::tcp::socket`, you would write:
    @code
        asio::io_context ioc;
        asio::ssl::context ctx{asio::ssl::context::sslv23};
        beast::ssl_stream<asio:ip::tcp::socket> sock{ioc, ctx};
    @endcode

    In addition to providing an interface identical to `asio::ssl::stream`,
    ...
    @li Uses @ref flat_stream internally, as a performance work-around for a
        limitation of `asio::ssl::stream` when writing buffer sequences
...
{
    using ssl_stream_type = asio::ssl::stream<NextLayer>;
...
public:
    ...
    */
    ...
    /** Get the underlying implementation in the native type.
        ...
        @code
        beast::ssl_stream<asio:ip::tcp::socket> ss{ioc, ctx};
    ...
    */
    void
    set_verify_mode(asio::ssl::verify_mode v)
    {
    ...
    */
    ...
    /** Set the callback used to verify peer certificates.
        ...
        @code bool verify_callback(
          bool preverified, // True if the certificate passed pre-verification.
          asio::verify_context& ctx // The peer certificate and other context.
        ); @endcode
        The return value of the callback is true if the certificate has passed
        verification, false otherwise.
    ...
    */
    ...
    /** Write some data to the stream.
        ...
        peer. Consider using the `asio::write` function if you need to
    ...
    */
    ...
    /** Start an asynchronous write.
        ...
        the peer. Consider using the `asio::async_write` function if you
    ...
    */
    ...
    /** Read some data from the stream.
        ...
        bytes. Consider using the `asio::read` function if you need to ensure
    ...
    */
    ...
    /** Start an asynchronous read.
        ...
        number of bytes. Consider using the `asio::async_read` function
